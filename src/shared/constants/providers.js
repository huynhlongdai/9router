...
export const FREE_TIER_PROVIDERS = {
  ...
  "vercel-ai": { id: "vercel-ai", alias: "vai", name: "Vercel AI Gateway", icon: "hub", color: "#000000", textIcon: "VA", website: "https://vercel.com/ai-gateway", passthroughModels: true, serviceKinds: ["llm", "embedding"], notice: { text: "Unified gateway: 100+ models from OpenAI, Anthropic, Google, xAI, Meta and more. Free credits on signup. Zero token markup. Model format: provider/model (e.g. openai/gpt-5.4).", apiKeyUrl: "https://vercel.com/account/settings/ai-gateway" } },
};
